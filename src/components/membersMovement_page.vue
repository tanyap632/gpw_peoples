...
async function fetchData() {
  const res = await fetch('https://f35b386a591e2f62.mokky.dev/membersPartisanMovement')
...
function goToDetail(id) {
  router.push({ name: 'card_detailMembersMovement', params: { id } })
}
</script>
  ...
  <div class="max-w-230 hidden"></div>
    ...
    <div class="max-w-250 hidden"></div>
      ...
      <div class="max-w-295 hidden"></div>
         <div class="max-w-391 hidden"></div>
...
<template>
  <div class="block max-w-1640 mx-auto">
    <div class="flex gap-[30px] text-4xl font-bold items-center font-ptsans">
      ...
      <p>Участники партизанского и подпольного движения</p>
    </div>
    <div class="mt-100">
