...
onMounted(async () => {
  try {
    const response = await fetch('https://f35b386a591e2f62.mokky.dev/employeesEnterprises')
    ...
    document.title = item.value.name || 'Работники предприятий, военных объектов, наркоматов, ведомств, организаций, корреспонденты, дикторы, кинооператоры '
