...
async function fetchData() {
  const res = await fetch('https://f35b386a591e2f62.mokky.dev/staffLaw')
...
function goToDetail(id) {
  router.push({ name: 'card_staffLaw', params: { id } })
}
</script>
...
<template>
  <div class="block max-w-1640 mx-auto">
    <div class="flex gap-[30px] text-4xl font-bold items-center font-ptsans">
      ...
      <p>Сотруднки органов внутренних дел и органов государственной безопасности</p>
    </div>
    <div class="mt-100">
