...
const routes = [
  ...
  },
  {
    ...
    {
    path: '/members-partisan-movement_page',
...
const router = createRouter({
  history: createWebHistory('/gpw_peoples/'), // или другой базовый путь
  routes,
})
